...
class CLoganProtocol implements LoganProtocolHandler {
     ...
     */
    private native int clogan_init(String cache_path, String dir_path, int max_file, String encrypt_key_16, String
            encrypt_iv_16);
     ...
     * @param is_main     是否主线程
     */
    private native int clogan_write(int flag, String log, long local_time, String thread_name, long thread_id, int
            is_main);
    ...
    public void logan_init(String cache_path, String dir_path, int max_file, String encrypt_key_16, String
        ...
        try {
            ...
            e.printStackTrace();
            loganStatusCode(ConstantCode.CloganStatus.CLGOAN_INIT_STATUS, ConstantCode.CloganStatus
                    .CLOGAN_INIT_FAIL_JNI);
        }
    }
    ...
    public void logan_open(String file_name) {
        ...
        try {
            ...
            e.printStackTrace();
            loganStatusCode(ConstantCode.CloganStatus.CLOGAN_OPEN_STATUS, ConstantCode.CloganStatus
                    .CLOGAN_OPEN_FAIL_JNI);
        }
    }
    ...
    public void logan_write(int flag, String log, long local_time, String thread_name, long thread_id, boolean
        ...
        try {
            ...
            e.printStackTrace();
            loganStatusCode(ConstantCode.CloganStatus.CLOGAN_WRITE_STATUS, ConstantCode.CloganStatus
                    .CLOGAN_WRITE_FAIL_JNI);
        }
    }

    private void loganStatusCode(String cmd, int code) {
        if (code < 0) {
            if (ConstantCode.CloganStatus.CLOGAN_WRITE_STATUS.endsWith(cmd) && code != ConstantCode.CloganStatus
                    .CLOGAN_WRITE_FAIL_JNI) {
